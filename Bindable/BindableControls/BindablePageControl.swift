...
open class BindablePageControl: UIPageControl, BindableControl {
    ...
    @objc func valueDidChange(_ control: UIPageControl) {
        bindable.value = control.currentPage
    }
}
